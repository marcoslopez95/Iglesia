                                    ...
                                    <td class="text-center">
                                        ...
                                        @else
                                            <div class="flex gap-4 justify-center  ">
                                                @if (auth()->user()->role === 1)
                                                    <a
                                                        href="{{ route('bautismos.show', ['bautismo_id' => $document->id]) }}">
                                                    ...
                                                    <form wire:submit="delete({{ $document->id }})">
                                                        <button type="submit">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                                class="w-6 h-6">
                                                    ...
                                                    {{-- <a tarjet="_blank" href="{{ route('bautismos.report',['bautismo_id'=>$document->id,'type_report'=>'doc']) }}" >
                                                ...
                                                @endif
                                                    <a tarjet="_blank" href="{{ route('bautismos.report',['bautismo_id'=>$document->id]) }}" >
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                            class="w-6 h-6">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
