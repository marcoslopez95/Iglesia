                    ...
                    <section>
                        ...
                        <form wire:submit="save" class="mt-6 space-y-6">
                            <div class="grid grid-cols-2 gap-10">
                                ...
                                <div class="">
                                    <x-input-label for="ci_child" value="Cédula del niño/niña" />
                            ...
                            <div class="grid grid-cols-2 gap-10">
                                ...
                                <div>
                                    <x-input-label for="ci_mother" value="Cédula de la mama" />
                            ...
                            <div class="grid grid-cols-2 gap-10">
                                <div>
                                    <x-input-label for="mother" value="Nombre de la papá" />
                                    <x-text-input wire:model="mother" id="mother" name="mother" type="text"
                                        class="mt-1 block w-full" autofocus autocomplete="Nombre Completo..." />
                                    <x-input-error class="mt-2" :messages="$errors->get('mother')" />
                                </div>
                            ...
                            <div class="grid grid-cols-2 gap-10">
                                ...
                                <div>
                                    ...
                                    class="mt-1 block w-full"/>
                                    <x-input-error class="mt-2" :messages="$errors->get('by_priets')" />
