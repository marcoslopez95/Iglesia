                ...
                <table class=""  style="font-size: 18px;">
                    <tr>
                        ...
                        <td style=" width: 70%; padding: 0px 20px">
                            ...
                            <p>
                                Según el acta reseña al margen; <br>
                                <span><b>{{ $document->child }}</b></span> hijo(a) de:<br>
                                <span><b>{{ $document->mother }}</b></span> y de <span><b>{{ $document->father }}</b></span>
                            </p>
                            <p>
                                Nacido(a) en <span>{{ $document->place_birth}}</span>
                                <br> el día
                                <span><b>{{ $birth->day }}</b></span> del mes
                                <span><b>{{ $birth->locale('es')->monthName }}</b></span> del
                                <span><b>{{ $birth->year }}</b></span>
                                Fue solemnemente bautizado(a) por: <br><span><b>{{ $document->by_priets }}</b></span><br> el día
                            ...
                            <p>
                                {{-- se expide el presente para fines de: <span>{{ $document->ending }}</span> --}}
                            </p>
                            <p>
